                        ...
                        <div className="w-full lg:w-7/12 bg-white p-5 rounded-lg lg:rounded-l-none">
                            ...
                            <form className="px-8 pt-6 pb-8 mb-4 bg-white rounded">
                                ...
                                <div className="text-center">
                                    <NavLink className="inline-block text-sm text-blue-500 align-baseline hover:text-blue-800" to="/forgot">
                                        Forgot Password?
                                    </NavLink>
                                </div>
                                <div className="text-center">
                                    <NavLink className="inline-block text-sm text-blue-500 align-baseline hover:text-blue-800" to="/login">
