        ...
        <div className="container mx-auto pt-8">
            <div className="lg:flex rounded-lg h-full">
                <div
                    ...
                    style={{ backgroundImage: "url('https://picsum.photos/id/133/670/1200')" }}
                ></div>
                    ...
                    <div className="w-full bg-white p-10 h-full rounded-xl">
                        ...
                        <div className="w-12/12 mx-auto mb-4 my-6 md:w-12/12 sm:px-10 sm:py-6 py-4 px-4 bg-white dark:bg-gray-800 ">
                            <div className="flex pb-3 items-center">
                                <p className="text-xl text-gray-800 dark:text-gray-100 font-semibold pl-2">Withdraw</p>
                                <br />
                            </div>
                            <div>
                            ...
                            <Formik
                                ...
                                onSubmit={(values, { setSubmitting }) => {
                                    setTimeout(() => {
                                        ...
                                        if (values.depositAmmount > state.actualBalance) {
                                            Swal.fire({
                                                position: "top-end",
                                                icon: "error",
                                                title: "You have no sufficient funds",
                                        ...
                                        dispatch({
                                            type: "LOG_OPERATION",
                                            payload: { date: mydate, operation: "withdraw", amount: values.depositAmmount },
                                        });
                                        Swal.fire({
                                            position: "top-end",
                                            icon: "success",
